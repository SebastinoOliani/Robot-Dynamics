...
w_ref_des=zeros(6,1);
q_ddot=pseudoInverseMat_solution(I_J_e,0.1)*(kpMat*chi_err+kdMat*(w_ref_des-I_J_e*q_dot)-I_dJ_e*q_dot);

tau=M_fun_solution(q)*q_ddot+b_fun_solution(q,q_dot)+g_fun_solution(q);
end